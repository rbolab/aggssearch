(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('funduniversApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-funduniversApp-error');
                var entityKey = httpResponse.headers('X-funduniversApp-params');
                if (errorHeader) {
